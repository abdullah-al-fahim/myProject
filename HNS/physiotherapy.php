        ...
        <div class="row mt-5">
            <div class="col-md-4 ">
                <div class="card  text-center">
                    ...
                    <div class="card-body">
                        <h3 class="card-title  cimg">Physiotherapy Support</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <p>Whether it’s a lingering back paina frozen shoulder or a sports injury that you’re looking to Physiotherapist.Physiotherapy may be a skilled career that has several specialties including musculoskeletal, orthopedics, cardiopulmonary, neurology, endocrinology, sports drugs, geriatrics, pediatrics, women's health, wound care and electromyography. medicine rehabilitation is above all a quickly rising field. PTs observe in several settings, like private-owned physiotherapy clinics, patient clinicsor offices, health and eudaimonia clinics, rehabilitation hospitals facilities, Home Physiotherapy In Dhaka, masterful nursing facilities, extended care facilities, personal homes, education and analysis centers, schools, hospices, industrial and this workplaces or alternative activity environments, fitness centers and sports training facilities.</p>
            </div>
        </div>
    </div>
    <!-- End Services -->
