...
if (isset($_REQUEST['psubmit'])) {
  ...
  if (($_REQUEST['pname'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")) {
    ...
    $filename = rand() . $_FILES["pImage"]["name"];
    $tempname = $_FILES["pImage"]["tmp_name"];

    $folder = "image/" . $filename;


    $sql = "INSERT INTO assets_tb (pname, pdop, pava, ptotal, poriginalcost, psellingcost,product_image) VALUES ('$pname', '$pdop','$pava', '$ptotal', '$poriginalcost', '$psellingcost','$filename')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" id="pname" name="pImage">
    </div>
    <div class="form-group">
