...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    <div class="form-group">
      <label for="inputRequestInfo">Patient Request</label>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputName" placeholder="Abdur Rahman" name="requestername">
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputAddress">Village</label>
        <input type="text" class="form-control" id="inputAddress" placeholder="House No. #13" name="requesteradd1">
      </div>
      <div class="form-group col-md-6">
        <label for="inputAddress2">Police Station</label>
        <input type="text" class="form-control" id="inputAddress2" placeholder="South khulshi" name="requesteradd2">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
    ...
    <button type="submit" class="btn btn-outline-info" name="submitrequest">Submit</button>
