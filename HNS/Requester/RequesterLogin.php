...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    <img src="../images/HNS (2).png" class="rounded-circle mb-1" alt="" style="height:45px; ">
    <span>Home Nursing Services</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-users text-info"></i> <span>Patient Login</span>
  </p>
    ...
    <div class="row justify-content-center custom-margin">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
          ...
          <button type="submit" class="btn btn-outline-info mt-3 btn-block shadow-sm font-weight-bold">Login</button>
          <?php if (isset($msg)) {
            echo $msg;
          } ?>
        </form>
        <div class="text-center"><a class="btn btn-danger mt-3 shadow-sm font-weight-bold" href="../index.php">Back
            to Home</a></div>
      </div>
    </div>
  </div>
