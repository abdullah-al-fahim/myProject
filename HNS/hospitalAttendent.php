...
<body>
    ...
    <div class="container rounded bg-light p-5" id="services">
        <div class="row mt-5">
            ...
            <div class="col-md-8">
                <p>Sometime we need to go hospital for daily checkup but we don't have any person for support the patient.There are measure many instances once all you wish may be a help reception for taking care of daily wants of your older or a loved one littered with chronic illness will be wherever having a caretaker reception can be thus useful.
                    Sheba Agency understands the sort of support you may want once 24/7 care and a spotlight is needed for your you liked one. That's why we offer certified and old non-medical attendants as a part of our Attendant Service
                </p>
            </div>
        </div>
    </div>
