        ...
        <div class="row mt-5">
            <div class="col-md-4 ">
                <div class="card  text-center">
                    ...
                    <div class="card-body">
                        <h3 class="card-title  cimg">Spacial Care</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
                <p>We are supporting covid19 patient and other critical disease at home.Covid suspected patient is dangerious for other patient so we collect sample for that patient at home. it safe for other people and patient. If patient is not possitive then he/she did not mix othe patient at hospital so home is safe for that type of patient.</p>
                <p></p>
            </div>
        </div>
    </div>
